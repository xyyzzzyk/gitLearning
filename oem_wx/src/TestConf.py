...
TestConf = {
    ...
    "APP_ID"                : 1000002,
    "APP_SECRET"            : "-Kx-sg3OG-JbYFY-UUALJnY6s5vZKndt6nRLl97V5HU",

    # 打卡应用的 id 及secrete， 在管理端 -> 企业应用 -> 基础应用 -> 打卡，
    # 点进去，有个"api"按钮，点开后，会看到
    "CHECKIN_APP_ID"        : 3010011,
    "CHECKIN_APP_SECRET"    : "2tteFwZ21apURZN2pICSVVardO5PXa1r8nDfkT1IoSE",

    # 审批应用的 id 及secrete， 在管理端 -> 企业应用 -> 基础应用 -> 审批，
    # 点进去，有个"api"按钮，点开后，会看到
    "APPROVAL_APP_ID"       : 3010040,
    "APPROVAL_APP_SECRET"   : "cMcbuPYxmOTAUAT_evZAXJtMzmLCfXw7-h7h0Kh14nw",
}
